...
{
	[CustomPropertyDrawer(typeof(IntConstraint))]
	public class IntConstraintDrawer : PropertyDrawer
	{
		public const string Stylesheet = "IntConstraintStyle.uss";
		public const string UssClassName = "pirho-int-constraint";
		...
		{
			var hasMinProperty = property.FindPropertyRelative(nameof(IntConstraint.HasMinimum));
			var hasMaxProperty = property.FindPropertyRelative(nameof(IntConstraint.HasMaximum));
			var minProperty = property.FindPropertyRelative(nameof(IntConstraint.Minimum));
			var maxProperty = property.FindPropertyRelative(nameof(IntConstraint.Maximum));
			...
			var min = new IntegerField { bindingPath = minProperty.propertyPath };
			var max = new IntegerField { bindingPath = maxProperty.propertyPath };
